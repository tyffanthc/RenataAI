...
- Trade: alerty jackpotow + edycja progow widoczne w FREE.
...
#### BUG-TTS-MESSAGE-ID-01 - Restore key voice events via message_id (DONE)
- Przywrocone kluczowe komunikaty TTS: smuggler alert, Water World, terraformable world, bio signals high, trade jackpot.
...
**Ostatni wynik smoke:** 2026-01-31 ? backend 15/15 OK, journal 5/5 OK
