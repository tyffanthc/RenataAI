    ...
    "trade": TableSchema(
        ...
        columns=_cols(
            [
                ...
                TableColumn("commodity", ui.TABLE_HDR_COMMODITY, value_path="commodity_display", width=18),
                TableColumn("profit", ui.TABLE_HDR_PROFIT, value_path="total_profit", fmt="cr", align="right", width=12),
                TableColumn("profit_per_ton", ui.TABLE_HDR_PROFIT_TON, value_path="profit", fmt="cr", align="right", width=12),
                TableColumn("jumps", ui.TABLE_HDR_JUMPS, fmt="int", align="right", width=8),
