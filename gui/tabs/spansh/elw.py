...
class ELWTab(SpanshPlannerBase):
    ...
    def _build_ui(self):
        ...
        if self._use_treeview:
            self.lst = common.stworz_tabele_trasy(fr, title=ui.LIST_TITLE_ELW)
        else:
            self.lst = common.stworz_liste_trasy(fr, title=ui.LIST_TITLE_ELW)
